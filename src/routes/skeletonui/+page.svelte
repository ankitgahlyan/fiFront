...
<header class="sticky top-0 z-50 bg-surface-50-950 shadow-xl">
	<div class="container mx-auto grid grid-cols-[auto_1fr_auto] items-center gap-10 p-4">
		...
		<p class="collapse text-xs opacity-60 md:visible">Test various feature provided by Skeleton.</p>
		...
		<div class={previewCardClasses}>
			<div class="mx-auto max-w-xl">
				<blockquote class="blockquote">
					"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt, aliquid. Molestias,
					odio illum voluptatibus natus dignissimos, quidem est unde aspernatur veniam pariatur fuga
